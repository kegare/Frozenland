...
public class ItemSwordIce extends ItemSword
{
	public ItemSwordIce(int itemID, String name)
	{
	...
	@Override
	public boolean hitEntity(ItemStack itemstack, EntityLivingBase target, EntityLivingBase entityLiving)
	{
		Random random = new Random();
		BiomeGenBase biome = entityLiving.worldObj.getBiomeGenForCoords((int)entityLiving.posX, (int)entityLiving.posZ);
