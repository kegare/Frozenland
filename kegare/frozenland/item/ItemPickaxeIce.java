...
public class ItemPickaxeIce extends ItemPickaxe
{
	public ItemPickaxeIce(int itemID, String name)
	{
	...
	{
		return block != null && block.blockMaterial == Material.ice ? 1.5F : super.getStrVsBlock(itemstack, block);
	}
	...
	{
		return block != null && block.blockMaterial == Material.ice ? true : super.canHarvestBlock(block);
	}
